...
Note: E𝄳 and B𝄳 represent E half-flat and B half-flat. The basic 4-note jins (D E𝄳 F G♭) uses the first three intervals here: N2 - N2 - m2.
...
- **Key features**:
  ...
  - Two consecutive neutral seconds (D-E𝄳 and E𝄳-F) give Saba its compressed feeling
  - Minor second (F to G♭)
...
- The two consecutive neutral seconds (D-E𝄳-F) create the characteristic "compressed" Saba feel before resolving into the lowered 4th
...
- **Pattern**: ¾ - ¾ - m2 | **Semitones**: 1.5 1.5 1 | **Cents**: 150 150 100
